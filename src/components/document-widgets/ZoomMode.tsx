    ...
    public render() {
        ...
        return (
            <div style={{ display: 'inline-block' }}>
                ...
                >
                    <MenuItem onClick={() => this.closeZoomMenu('fit')}><ZoomOutMap /> &nbsp; {localization.zoomModeFit} </MenuItem>
                    <MenuItem onClick={() => this.closeZoomMenu('originalSize')}><AspectRatio />&nbsp; {localization.zoomModeOriginalSize} </MenuItem>
                    <MenuItem onClick={() => this.closeZoomMenu('fitHeight')}><Code style={{ transform: 'rotate(90deg)' }} /> &nbsp; {localization.zoomModeFitHeight} </MenuItem>
                    <MenuItem onClick={() => this.closeZoomMenu('fitWidth')}><Code /> &nbsp; {localization.zoomModeFitWidth} </MenuItem>
                    <Divider light />
