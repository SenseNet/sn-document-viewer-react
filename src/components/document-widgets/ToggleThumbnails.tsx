    ...
    public render() {
        return (
            <div style={{ display: 'inline-block' }}>
                <IconButton title={this.props.toggleThumbnailsTitle} style={{ opacity: this.props.showThumbnails ? 1 : 0.5 }}>
                <svg onClick={() => this.toggleThumbnails()} version="1.1" xmlns="http://www.w3.org/2000/svg" style={{width: '1em', height: '1em', fill: 'white'}} viewBox="0 0 1000 1000" enableBackground="new 0 0 1000 1000">
